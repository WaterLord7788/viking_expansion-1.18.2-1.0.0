...
@OnlyIn(Dist.CLIENT)
public class SapphireArrowEntityRenderer<T extends AbstractArrow> extends EntityRenderer<T>{
    protected SapphireArrowEntityRenderer(EntityRendererProvider.Context context) { super(context); }


    public static final ResourceLocation SAPPHIRE_ARROW_ENTITY_TEXTURE = new ResourceLocation(VikingExpansion.MOD_ID, "textures/entity/projectile/sapphire_arrow.png");
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return SAPPHIRE_ARROW_ENTITY_TEXTURE;
    }
